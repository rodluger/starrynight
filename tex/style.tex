...
% Elliptic integrals
\newcommand{\DE}{\Delta \mathbbb{E}\left(\valpha \,\Big|\, \frac{1}{k^2}\right)}
\newcommand{\DF}{\Delta \mathbbb{F}\left(\valpha \,\Big|\, \frac{1}{k^2}\right)}
\newcommand{\DPi}{\Delta \pmb{\mathbb{\Pi}}\left(n; \valpha \,\Big|\, \frac{1}{k^2}\right)}
