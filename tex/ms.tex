...
\begin{align}
    \label{eq:F}
    \mathbb{F}(\psi \,|\, m) & \equiv \int_0^{\psi} \frac{\dd \varphi}{\sqrt{1 - m \sin^2 \varphi}}
    \\
    \intertext{and}
    \label{eq:E}
    \mathbb{E}(\psi \,|\, m) & \equiv \int_0^{\psi} \sqrt{1 - m \sin^2 \varphi} \, \dd \varphi
    \quad,
\end{align}
%
...
%
\begin{align}
    \mathbb{F}\left(\psi \,\Big|\, \frac{1}{k^2}\right) & =
    k \, \mathbb{F}(\beta \,|\, k^2)
    \nonumber                                                                                        \\
    \mathbb{E}\left(\psi \,\Big|\, \frac{1}{k^2}\right) & =
    \frac{\mathbb{E}(\beta \,|\, k^2) - (1 - k^2) \mathbb{F}(\beta \,|\, k^2)}{k}
    \\
    \intertext{with}
...
\end{proof}
%
The quantities $\mathbbb{F}(\valpha \,|\, \nicefrac{1}{k^2})$ and
$\mathbbb{E}(\valpha \,|\, \nicefrac{1}{k^2})$
...
While stable algorithms exist to evaluate $\mathbb{\Pi}(n; \psi \,|\, m)$
