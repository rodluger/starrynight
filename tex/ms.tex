...
Figure~\ref{fig:earthphase} shows...
...
\begin{figure}[p!]
    \begin{centering}
        ...
        \oscaption{earthphase}{%
            ...
            to spherical harmonic degree $l = 25$. The main plot shows the
            phase curve over the course of one year.
...
\begin{figure}[p!]
    \begin{centering}
        ...
        \oscaption{earthsun}{%
            Mock secondary eclipse light curves of the
            cloudless Earth expanded to spherical harmonic degree $l = 25$.
            Black curves show the analytic solution; orange dots correspond
            to brute force numerical integration on a grid of
            ${\sim}10^6$ points.
            ...
            normalized reflected and normalized emitted light curves.
            \label{fig:earthsun}
        }
    \end{centering}
\end{figure}
...
\begin{figure}[ht!]
    \begin{centering}
        ...
        \oscaption{kelt9b}{%
            Reflected light phase curve model (left) and
            secondary eclipse model for Kelt-9b, assuming
            a spherical albedo $A = 0.2$. The transit (phase zero)
            is not included. Blue is the \starry model
            assuming a point source illumination; orange accounts for
            the finite size of the star. The right panel shows
            the normalized flux during secondary eclipse ingress
            for the two \starry models and for two approximations:
            a surface with uniform intensity (solid purple)
            and a surface whose intensity falls as the cosine of the
