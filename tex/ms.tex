...
version archived at \xxx{https://doi.org/XX.XXXX/zenodo.XXXXXXX}.
...
\xxx{Is this explanation sufficient? Why does it matter that this
...
\begin{proof}{PhaseCurve}
    \label{eq:IJKrec}
    \mathbb{k}_{j}(b) &= \frac{b^j b_c^3 + (j - 1) \mathbb{k}_{j - 2}(b)}{j + 2}
    %
    \nonumber \\
    %
