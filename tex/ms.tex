...
flux-weighted integral of $A(\lambda)$ over all wavelengths $\lambda$. For
more details, see \S4.5 of \citet{Schwartz2015}.
...
which we discuss in more detail in \S\ref{sec:adapting-starry}.
...
\begin{figure}[h!]
    \begin{centering}
        ...
        \oscaption{earthmoon}{%
            ...
            equivalent to Figure~7 in \citet{Luger2019}.
...
\section{Extended illumination source}
\label{sec:extended}
Planets to consider: 55 Cnc e, Kelt-9b.
The angular extent of the terminator past $\nicefrac{\pi}{2}$ is
%
\begin{align}
    \tau = \arcsin\left( \frac{\Delta R}{d} \right)
\end{align}

\section{Non-Lambertian scatterers}
\label{sec:nonlambertian}
In principle, we can just change $\mathbf{I}$.
...
%
\begin{proof}{}
    \mathcal{I}_\text{full}(x, y) = \frac{\sqrt{1 - x^2 - y^2}}{\pi z_s^2}
    \quad.
\end{proof}
%
...
\begin{proof}{}
    ...
    \frac{\sqrt{1 - x^2 - y^2}}{\pi z_s^2}
    \,
    \dd y
    \,
    \dd x
    \nonumber \\[0.5em]
    &= \left(\frac{2}{3}\right) \frac{1}{z_s^2}
    \quad,
\end{proof}
%
...
\xxx{Is this explanation satisfactory? Does it make sense?}
