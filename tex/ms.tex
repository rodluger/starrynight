...
\end{align}
%
We may compute it by either upward or downward recursion. In the upward
case, we start with the lower boundary condition
%
\begin{proof}{}
    \iW_0 &= \Delta
    \Bigg\{
    \frac{\sinhalfkap[2]}{5}
    \left(
    \frac{1 - \mathbf{q}(k^2, \vkappa)^2}{1 - \mathbf{q}(k^2, \vkappa)^3}
    +
...
\end{align}
%
we may recurse upward in $\iW$ and $\mathbf{c}$ simultaneously:
%
\begin{proof}{}
    \label{eq:Wv}
    \iW_v                      & =
...
condition for $v = \vmax$,
%
\begin{proof}{}
    \label{eq:Wsol}
    \iW_\vmax &=
    \frac{\sin^{2\vmax + 2}\left(\frac{\vkappa}{2}\right)}{\vmax + \frac{5}{2}}
    \left(
...
We then recurse downward \xxx{...}
\xxx{TODO: Check these expressions.}
