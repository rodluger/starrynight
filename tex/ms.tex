...
\begin{figure}[t!]
    \begin{centering}
        ...
        \oscaption{cases}{%
            The eight principal families of cases of occultations in
            reflected light.
...
\begin{figure}[t!]
    \begin{centering}
        ...
        \oscaption{pathological}{%
            Two additional families of occultations in reflected light,
            involving rare triple (case 9, left) and quadruple
            (case 10, right) intersections between the limb of the
            occultor and the terminator of the occulted body. Both cases
            involve integration over two disjoint regions (bounded by
            the orange curves in the figure). The insets next to each case
            show a zoomed-in version of two such regions. See text for
            more details.
...
Finally, cases 9 and 10 correspond to (rare) configurations involving three
or four roots to Equation~\ref{eq:quartic}, respectively, and are
illustrated in Figure~\ref{fig:pathological}.
