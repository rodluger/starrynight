...
\xxx{In general, we do not just integrate over the dayside. We integrate over
    the simplest region -- usually the one with the fewest boundaries --
...
\xxx{It is useful to} define the pairwise difference operator
%
\begin{align}
    \label{eq:pairdiff}
