...
%
\xxx{Add equations for the rotation and change of basis matrices below.}
...
%
$\mathbf{A}$ is the change-of-basis matrix from $\by$
...
%
$\mathbf{A_1}$ is the change-of-basis matrix from the spherical harmonic
...
(Equation~\ref{eq:A}), where $\mathbf{A_1}$ transforms from
...
$\mathbf{R}'' = \mathbf{R}''(x_s, y_s)$ (Equation~\ref{eq:R''}) rotates
...
\begin{proof}{}
    ...
    \begin{dcases}
        ...
        V
        \left(
        \Big\lfloor\frac{\mu + 4}{4}\Big\rfloor,
        \frac{\nu}{2},
        0;
        \viU
        \right)
...
\citet{Luger2019} the $n = 2$ term of $\pT$ (second case in the
...
\end{align}
%
This integral also has a closed-form solution:
%
\begin{proof}{}
    \label{eq:Wsol}
    \iW_n =
    \frac{\sin^{2n + 2}\left(\frac{\vkappa}{2}\right)}{2n + 5}
    \left(
    \frac{3}{n+1}
...
%
\xxx{Figure out the integral form, and write up the recursion relations.}
